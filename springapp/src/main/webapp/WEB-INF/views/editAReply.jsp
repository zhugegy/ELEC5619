...
<html>
	<head>
		<title><fmt:message key="forum.editAReply.title" /></title>
	</head>
	<body>
		...
		|
		<h1>
			<fmt:message key="forum.editAReply.heading" />
		</h1>
		<p>
			<fmt:message key="forum.editAReply.greeting" />
			<c:out value="${model.now}" />
		</p>
		<form action="editAReply" method="post">
			Content:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <textarea type="text" name="content" rows="6" cols="62"/></textarea>
			<br>
			<br>
			<input type="hidden" name="custId" value="${model.topicid}">
			<input type="hidden" name="custId2" value="${model.topicreplyserial}">
