...
<html>
	<head>
		<title><fmt:message key="forum.searchResults.title" /></title>
...
.right {
	...
	<body>
		...
		|
		<h1>
			<fmt:message key="forum.searchResults.heading" />
		</h1>
		<p>
			<fmt:message key="forum.searchResults.greeting" />
  ...
  <tbody>
     <c:forEach items="${model.topics}" var="topi">
       <tr>
		...
		<br>
		<a href="<c:url value="viewAllTopics.htm"/>">View All Topics</a>
		<br>
