...
<html>
	...
	<body>
		...
		<div class="thumbnail">
				<h1 class="stats"><c:out value="name: ${sal.name}" /></h1>
				<h4><i>$<c:out value="price: ${sal.price}" /></i></p>
				<p><c:out value="description: ${sal.description}" /></p> 
				<p><c:out value="quantity: ${sal.quantity}" /></p> 
				<p><c:out value="status: ${sal.status}" /></p> 
